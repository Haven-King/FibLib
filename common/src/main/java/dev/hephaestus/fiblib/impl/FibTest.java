...
public class FibTest {
    public static void fibIronOre() {
        ...
        BlockFib fib = BlockFib.builder(Registry.BLOCK.get(ironOre), Registry.BLOCK.get(stone)).build();
    ...
    public static void fibCoalOre() {
        ...
        ResourceLocation stone = new ResourceLocation("minecraft:stone");
        BlockFib fib = BlockFib.builder(Registry.BLOCK.get(coalOre), Registry.BLOCK.get(stone))
